...
parser.add_argument(
    "--n-nodes", type=int, help="Number of nodes", default=100
)
...
training_dataset = SBMMixtureDataset(args.n_graphs, args.n_nodes, K, pq = [[P, Q]] * args.n_graphs)
